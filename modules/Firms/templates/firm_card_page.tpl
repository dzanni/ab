<div class="page-inner page-comp03">
	...
	<main>
		{*{if $menu}*}
			{*<div class="content__block">*}
				{*<div class="content__block_firm_menu">*}
					{*<a href="/firms/?firm={$firm_pages.firm}" class="button button--orange">Главная</a>*}
					{*{foreach from=$menu item=m}*}
						{*<a href="/firms/?firm={$firm_pages.firm}&firmpage={$m.id}" class="button button--orange">{$m.title}</a>*}
					{*{/foreach}*}
				{*</div>*}
			{*</div>*}
		{*{/if}*}
			...
			<div class="content__comp-info">
				<div class="comp__info">
					...
					<div class="comp__item-rating">
						...
						<div class="comp__item-rating-count">{$rating}</div>
		...
		{if $firm_pages.right_block}
		<div class="comp__column">
			<div class="comp__block">
				{/if}
				{*<div class="content__block">*}
					{*<div class="block__title">{$firm_pages.firm_title}: {$firm_pages.title}</div>*}
				{*</div>*}
				<div class="white_chg {if $white_back}no_border{/if}">
