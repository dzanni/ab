...
$request->appendGetFilterByDetail($_GET['f'], $_GET['vid'], $_GET['uid'], $_GET['did']);
...
<script type="text/javascript">
    ...
    {
        var url = '<?php echo 'unit.php?&c='.$_GET['c'].'&vid='.$_GET['vid'].'&cid='.$_GET['cid'].'&uid='.$_GET['uid'].'&ssd=$'?>';
