        ...
        <main>
            ...
            <div class="content__block profile__content">
                ...
                <div class="content__profile-info">
                    ...
                    {if $user.invited}
                    <div class="comp__item-rating-t">
                        <p>Пригласил пользователей: {$user.invited}</p>
                    </div>
                   {/if}
                    ...
                    {if $user.id != $current_user->id}
                        {if $current_user->status == 1}
                            <a class="button button--orange" href="/account/messages/?user_to={$user.id}">Отправить сообщение</a>
                        {else}
                            <a class="button button--orange open__popup" href="#popup__new">Отправить сообщение</a>
                        {/if}
                    {/if}
...
<div class="render_popup-title">Добавить</div>
                    ...
                    {if $user.can_edit}
                        ...
                        <a class="button button--orange js_render_work_button {*margin_right*}" href="/account/users/?lk_users_edit_profile={$user.id}">Редактировать</a>
                        {* {if !$user.tlg_id && $current_user->id == $user.id}<a class="button button--orange" href="https://t.me/aboss_expert_bot" target="_blank">Привязать к телеграм</a>{/if} *}
                        </div>
                    {/if}
            ...
            {if $user.my_publications_txt}
                <div class="content__block">
                <div class="block__title">Мои выступления и публикации</div>
                <div class="block__content">
                    {$user.my_publications_txt}
                </div>
                </div>{/if}
                    ...
                    <div class="block__content">
                        ...
                        <div class="block__list-data">
                            ...
                            {if $current_user->auth}
                               ...
                               {* {if $user.tlg_show && $user.tlg}
                                    <div class="block__item">
                                        <div class="block__item-inner">
                                            <svg class="svg-sprite-icon icon-icon__tlg">
                                                <use xlink:href="/i/v2/svg/symbol/sprite.svg#icon__phone"></use>
                                            </svg>
                                            <div class="block__item-info">
                                                <div class="block__item-label">Телеграм:</div>
                                                <div class="block__item-value">{$user.tlg}</div>
                                            </div>
                                        </div>
                                    </div>
                                {/if} *}
